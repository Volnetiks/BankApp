...
class AnimatedAnalyticsState extends StatefulWidget {
  const AnimatedAnalyticsState({super.key});

  @override
  State<AnimatedAnalyticsState> createState() => _AnimatedAnalyticsStateState();
}

class _AnimatedAnalyticsStateState extends State<AnimatedAnalyticsState>
